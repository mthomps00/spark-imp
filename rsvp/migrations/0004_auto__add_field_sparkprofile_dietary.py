...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SparkProfile.dietary'
        db.add_column('rsvp_sparkprofile', 'dietary',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=140, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SparkProfile.dietary'
        db.delete_column('rsvp_sparkprofile', 'dietary')
